...
insured_translations = {
  ...
  "en.insured.consumer_roles.docs_shared.alien_number_title" => "• When entering an Alien Number, only include the numbers. Do not enter the 'A' or any other characters or letters. For example: If your Alien Number is 'A123456789' then please enter '123456789'.
  • You must enter exactly 9 digits into the Alien Number field. For Alien Numbers with fewer than 9 digits, add one zero (0) to the beginning of an 8-digit Alien Number and two zeroes (00) to the beginning of a 7-digit Alien Number. For example: If your Alien Number is 'A1234567' then please enter '001234567'.
  • Pre-1956 certificates do not contain an Alien Number. In this case, enter \"999999999\” for the Alien Number. (check for 9 digit numbers).",
  "en.insured.consumer_roles.docs_shared.card_number" => "Card Number",
  "en.insured.consumer_roles.docs_shared.card_number_title" => "
  ...
  "en.insured.consumer_roles.docs_shared.citizenship_number_title" => "• When entering a Citizenship Certification Number, include all numbers and letters. Do not enter any other characters or spaces.
  • The Certification number entered must have between 6 and 12 characters.
  ...
  "en.insured.consumer_roles.docs_shared.i94_number_title" => "
  ...
  "en.insured.consumer_roles.docs_shared.naturalization_number_title" => "
  ...
  How to find the Naturalization Number: The Naturalization Certificate Number is most often in the upper right hand corner of the Certificate. The Naturalization Certificate Number is printed in red on all US Certificates of Citizenship issued since September 27, 1906.",
  "en.insured.passport_number" => "Passport Number",
  "en.insured.passport_number.title" => "
  • When entering a Passport Number, include all numbers and letters. Do not enter any other characters or spaces.
  • The Passport Number that you enter must have between 6 and 12 numbers and letters.",
  "en.insured.consumer_roles.docs_shared.sevis_id" => "SEVIS ID",
  "en.insured.consumer_roles.docs_shared.sevis_id_title" => "
  • When entering a SEVIS ID, only include the numbers. Do not enter the 'N' or any other characters or letters. For example: If your SEVIS ID is 'N1234567891' then please enter '1234567891'.
  • The SEVIS ID entered must have 10 digits.
  ...
  "en.insured.consumer_roles.docs_shared.visa_number_title" => "
      Please enter the Visa Number exactly as it appears on the document. You must enter exactly eight letters and numbers. You may not enter any special characters.",
  ...
  "en.submit" => "Submit",
  "en.insured.individual_and_family" => "Individual & Family",
  "en.premium" => "Premium",
  ...
  "en.insured.future_enrollment_termination_date" => "Future enrollment termination date",
  ...
  "en.insured.need_help_sign_up" => "Need Help Signing Up?",
  "en.insured.click_help_me_sign_up" => "Click \"Help Me Sign Up\" to be connected to a trained expert.",
  "en.insured.help_me_sign_up" => "Help Me Sign Up",
  "en.step" => "Step %{number}",
  ...
  "en.back" => "Back",
  "en.insured.documents_view_important_noticies" => "The Documents folder is a safe and convenient way for you to view and keep track of important notices and communications you receive from %{site_short_name}. You'll receive an email notification when there are new documents for you to review.",
  "en.download_tax_documents" => "Download Tax Documents",
  "en.upload_document" => "Upload Document",
  "en.insured.documents_index_verify_information" => "We verify the information you give us using electronic data sources. If the data sources do not match the information you gave us, we need you to provide documents to prove what you told us.",
  "en.insured.special_enrollment_period" => "Special Enrollment Period",
  "en.insured.final_sep_experienced_any_events" => "Have you or anyone in your household recently experienced any of the following events?",
  "en.insured.final_sep_none_of_the_situations_listed" => "None of the situations listed above apply.",
  "en.insured.outside_open_enrollment" => "Outside Open Enrollment",
  "en.insured.final_sep_open_enrollment_body" => "Open enrollment starts on %{next_ivl_open_enrollment_date}. To enroll before open enrollment, you must qualify for a special enrollment period. If none of the circumstances listed apply to you, you will not be able to enroll until %{next_ivl_open_enrollment_period}",
  ...
  "en.insured.group_selections.coverage_household_ineligible_coverage" => "This dependent is ineligible for employer-sponsored %{coverage_kind} coverage.",
  "en.insured.group_selections.new.choose_coverage_for_your_household" => "Choose Coverage for your Household",
  "en.insured.group_selections.new.select_who_needs_coverage" => "Select who needs coverage and the type of coverage needed. When you’re finished, select CONTINUE.",
  "en.insured.group_selections.new.who_needs_coverage" => "Who Needs Coverage?",
  "en.insured.group_selections.new.marketplace" => "Marketplace",
  "en.insured.group_selections.new.employee_sponsored_benifits" => "Employer-Sponsored Benefits",
  "en.insured.group_selections.new.individual_benifits" => "Individual Benefits",
  "en.employer" => "Employer",
  "en.health" => "Health",
  "en.dental" => "Dental",
  "en.insured.group_selections.new.coverage_begin_ivl_enrollment_effective_date" => "If you enroll today, coverage will begin %{ivl_enrollment_effective_date}.",
  "en.insured.group_selections.new.need_coverage_earlier_html" => "Do you need coverage earlier? See if you qualify for a <a href='#' id='find_sep_link'>Special Enrollment Period</a>",
  "en.insured.group_selections.new.show_residency_alert_msg" => "Since %{full_name} is not a resident of the %{aca_state_name} she/he is not eligible to purchase a plan through %{ site_short_name}. Other members may still be eligible to enroll. Please call us at %{contact_center_phone_number} to learn about other health insurance options for %{full_name}.",
  "en.insured.group_selections.new.what_would_you_like_to_do" => "What would you like to do?",
  ...
  "en.insured.group_selections.terminate_confirm.terminate_this_plan_do_you_wish_proceed" => "Terminating this plan will terminate coverage for all members of your family. Do you wish to proceed? Y/N.",
  "en.insured.group_selections.terminate_confirm.terminate_confirm_note_html" => "<strong>Note:</strong>Federal law allows your plan(s) to require that you make your request for termination no less than 14 days before the date you want your coverage to end. This requirement was included in the notice that you received from %{site_short_name} after you enrolled in your plan.",
...
insured_translations.each do |k,v|
  Translation.where(key: k).first_or_create.update_attributes!(value: "\"#{v}\"")
end
