...
INSURED_TRANSLATIONS = {
  ...
  "en.insured.consumer_roles.search.enter_personal_info_msg" => "First, we need to verify whether you're new to %{Settings.site.short_name} or affiliated with another account. Please enter your personal information. When you're finished, select CONTINUE.",
