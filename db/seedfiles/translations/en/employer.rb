EMPLOYER_TRANSLATIONS = {
  ...
  'en.er_attestation' => 'Employer Attestation',
  'en.employers.employer_profiles.until_oe_ends' => 'Until Open Enrollment Ends',
  'en.day' => 'Day',
  'en.business_info_update' => 'Update Business Info',
  'en.view_enroll_reports' => 'View Enrollment Reports',
  'en.my_ee' => 'My Employees',
  'en.my_home' => 'My #{site_short_name}',
  'en.billing' => 'Billing',
  'en.create_er' => 'create employer',
  'en.employers.employer_profiles.er_profile_button_text' => 'Please click the following button to create an employer profile.',
  'en.search_er' => 'Search Employers',
  'en.secure_your_info' => 'Your information is secure.',
  'en.employers.employer_profiles.search_match_sic' => 'Search for your matching SIC Code',
  'en.employers.employer_profiles.sic_selection_text' => 'You can use browse or search through all the available codes -- click a SIC code to make a selection',
