...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.benefit_package.clear_selection' => "Clear Selection",
  ...
  :'en.employers.plan_years.employee_cost_details_description_part1' => "Details of the employee costs for your members are shown on the details page. Values are based on benefit type, contribution amounts, and reference plan chosen.",
