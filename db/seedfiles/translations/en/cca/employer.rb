...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.change_on_renewal' => "Change on renewal",
  :'en.employers.plan_years.starting_soon' => "Starting Soon",
  :'en.employers.plan_years.renewal' => "Renewal",
  :'en.employers.plan_years.renewal_change_benefit_model' => "Plan kind offering has changed",
  :'en.employers.plan_years.renewal_change_reference_plan' => "Reference plan has changed",
  :'en.employers.plan_years.renewal_change_employer_contribution' => "Contribution values changed",
  :'en.employers.plan_years.filters' => "Filters",
  :'en.employers.plan_years.filter_plan_years' => "Plan Year(s)",
  :'en.employers.plan_years.filter_active_and_renewal' => "Active & Upcoming",
  :'en.employers.plan_years.filter_sort' => "Sort",
  :'en.employers.plan_years.filter_sort_descending' => "Descending",
  :'en.employers.plan_years.filter_sort_ascending' => "Ascending",
  ...
  :'en.employers.plan_years.benefit_package.compare_selected_plans' => "Compare Selected Plans",
  :'en.employers.plan_years.benefit_package.export_to_pdf' => "Export to PDF",
  :'en.employers.plan_years.benefit_package.export_to_csv' => "Export to CSV",
  :'en.employers.plan_years.benefit_package.close' => "Close",
  :'en.employers.plan_years.benefit_package.compare' => "Compare",
  ...
  :'en.employers.plan_years.benefit_package.offered' => "Offered ",
  :'en.employers.plan_years.benefit_package.employer_contribution' => "Employer Contribution ",
  ...
  :'en.employers.plan_years.employee_cost_details_description_new' => "Details of the employee costs for your members are shown on the details page. Values are based on benefit type, contribution amounts, and reference plan chosen.",
  :'en.employers.plan_years.estimated_employee_costs' => "Estimated Employee Costs",
  :'en.employers.plan_years.view_employee_cost_details' => "View Employee Cost Details",
  :'en.employers.plan_years.details_page' => "details page. ",
  ...
  :'en.employers.plan_years.out_of' => ' out of ',
  :'en.employers.plan_years.have_enrolled_or_waived' => ' have enrolled or waived coverage',
