...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.renewal_change_benefit_model' => "Benefit model has changed",
  :'en.employers.plan_years.renewal_change_reference_plan' => "Carrier has changed",
  :'en.employers.plan_years.renewal_change_employer_contribution' => "Employer contribution has changed",
