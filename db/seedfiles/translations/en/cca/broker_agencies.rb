BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.broker_agencies.profiles.working_hours" => "EVENING/WEEKEND HOURS",
	...
	"en.broker_agencies.profiles.npn_taken_error" => "NPN has already been claimed by another broker. Please contact Health Connector for Business Customer Service at 1-855‑268‑3767",
	"en.broker_agencies.profiles.detailed_roster_information_part1" => "To create a quote for a new, prospective group, please",
	"en.broker_agencies.profiles.detailed_roster_information_part2" => "To create a quote for an existing group, use the roster below and update it as needed to reflect the plan enrollees.",
