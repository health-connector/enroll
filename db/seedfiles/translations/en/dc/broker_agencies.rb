BROKER_AGENCIES_TRANSLATIONS = {
	...
	"en.broker_agencies.broker_roles.name_fein" => "Name/FEIN",
	"en.clear_assign" => "clear assign",
	"en.quoting_tool" => "Quoting Tool",
	"en.commissions" => "Commissions",
	"en.compare_costs" => "Compare Costs",
	"en.save" => "Save",
	"en.add_benefit_group" => "Add benefit Group",
	"en.employee_cost" => "Employee Cost",
	"en.email" => "Email",
	"en.npn" => "NPN",
