  ...
  module EffectiveDatatable
    module Ajax
      ...
      def display_table_columns
        ...
        @display_table_columns ||= {}.tap do |retval|
      ...
      def order_name
        @order_name ||= if params[:order] && params[:columns]
                          order_by_column_index = begin
                        ...
                        end || table_columns.find { |_col, opts| opts[:type] != :bulk_actions_column }.first
      end

      def order_index
        (table_columns[order_name][:index] || 0)
      rescue StandardError
        0
      end
