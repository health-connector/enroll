...
Given("shop health plans exist for both last and this year") do
  ...
  sole_source_plan = FactoryBot.create :plan, :with_rating_factors, :with_premium_tables, active_year: year, market: 'shop', coverage_kind: 'health', deductible: 4000, carrier_profile_id: plan.carrier_profile_id, is_vertical: false,
                                                                                          is_horizontal: false, is_sole_source: true
  sole_source_plan_two = FactoryBot.create :plan, :with_rating_factors, :with_premium_tables, active_year: (year - 1), market: 'shop', coverage_kind: 'health', deductible: 4000, carrier_profile_id: plan.carrier_profile_id, is_vertical: false,
                                                                                              is_horizontal: false, is_sole_source: true
