...
And(/^system date is between submission deadline & effective date$/) do
  allow(TimeKeeper).to receive(:date_of_record).and_return((initial_application.effective_date - 1.day))
end
