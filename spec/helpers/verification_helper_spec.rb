...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  RSpec.describe VerificationHelper, :type => :helper do
    ...
    describe "#build_admin_actions_list" do
      shared_examples_for "admin actions dropdown list" do |type, status, state, actions|
        ...
        it "returns admin actions array" do
          person.consumer_role.update_attributes(aasm_state: state.to_s)
    ...
    describe "#request response details" do
      ...
      let(:ssa_request_body)       do
        "<?xml version='1.0' encoding='utf-8'?> <ssa_verification_request xmlns='http://openhbx.org/api/terms/1.0'>
      ...
      let(:vlp_request_body)       do
        "<?xml version='1.0' encoding='utf-8'?> <lawful_presence_request xmlns='http://openhbx.org/api/terms/1.0'>
      ...
      let(:residency_response_body) do
        "<?xml version='1.0' encoding='utf-8' ?>\n
      ...
      let(:ssa_response_body)      do
        "<?xml version='1.0' encoding='utf-8'?> <ssa_verification_response xmlns='http://openhbx.org/api/terms/1.0'>
                                    <id> <id>5a0b2901635d695b94000008</id> </id> <person> <id>
                                    <id>urn:openhbx:hbx:dc0:resources:v1:person:hbx_id#5c51371d9c04441899b29fb79086c4a0</id> </id>
      ...
      let(:vlp_response_body)     do
        "<?xml version='1.0' encoding='utf-8'?> <lawful_presence_response xmlns='http://openhbx.org/api/terms/1.0'>
                                    <individual> <id> <id>5a12f461635d690fa20000dd</id> </id> <person> <id>
      ...
      shared_examples_for "request response details" do |type, event, result|
        before do
          if ["local_residency_request", "local_residency_response"].include?(event)
