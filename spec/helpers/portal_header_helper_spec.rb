  ...
  describe "portal_display_name" do
    ...
    context "has_employer_staff_role?" do
      ...
      it "should have I'm an Employer link when user has active employer_staff_role" do
        expect(portal_display_name(controller)).to eq "<a class=\"portal\" href=\"/benefit_sponsors/profiles/employers/employer_profiles/#{emp_id}?tab=home\"><img src=\"/images/icons/icon-business-owner.png\" /> &nbsp; I'm an Employer</a>"
      end
