...
RSpec.describe Products::QhpController, :type => :controller, dbclean: :after_each do
  ...
  context "GET summary" do
    ...
    let(:qhp_cost_share_variance) do
      double("QhpCostShareVariance", product: double("Product", medical_individual_deductible: 200, medical_family_deductible: 400, rx_individual_deductible: 100, rx_family_deductible: 300, is_pvp_in_rating_area: false), :hios_plan_and_variant_id => "id")
    end
