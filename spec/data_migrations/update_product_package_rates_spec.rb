...
describe UpdateEmployeeRoleId, dbclean: :after_each do
  ...
  describe "update product package rates", dbclean: :after_each do
    ...
    let!(:benefit_application) do
      FactoryGirl.create(:benefit_sponsors_benefit_application, benefit_sponsor_catalog: benefit_sponsor_catalog, benefit_sponsorship: benefit_sponsorship, default_effective_period: effective_period, aasm_state: :active)
    end
