...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  ...
  describe Import2019IvlBenefitPackage, :dbclean => :after_each do
    ...
    describe "create 2019 benefit package for IVL market" do
      ...
      let!(:bcp) do
        FactoryBot.create(:benefit_coverage_period, start_on: Date.new(2018,1,1), end_on: Date.new(2018,12,31), open_enrollment_start_on: Date.new(2017,11,1), open_enrollment_end_on: Date.new(2018,1,31), title: "Individual Market Benefits 2018",
