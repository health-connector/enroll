  ...
  skip do
    ...
    describe "reinstate_plan_year", dbclean: :after_each do
      ...
      context "on reinstate of plan year with end date passed and has renewing plan year cancelled" do
        ...
        let!(:benefit_group) { FactoryBot.build(:benefit_group)}
        let!(:plan_year) do
          FactoryBot.build(:plan_year, aasm_state: 'terminated', open_enrollment_start_on: open_enrollment_start_on,open_enrollment_end_on: open_enrollment_end_on,start_on: start_on, end_on: end_on,terminated_on: end_on,
        ...
        let!(:terminated_enrollment) do
          FactoryBot.create(:hbx_enrollment, :terminated, effective_on: plan_year.start_on, terminated_on: plan_year.end_on, benefit_group_id: benefit_group.id, household: family.active_household, terminate_reason: "")
        end
