...
describe CorrectEmployeesWithIncorrectWaivers, dbclean: :after_each do
  ...
  describe "employer profile with employees present" do
    ...
    let!(:current_employee_enrollments) do
      ...
      create_enrollment(family: current_employee.person.primary_family, benefit_group_assignment: current_employee.census_employee.active_benefit_group_assignment, employee_role: current_employee, submitted_at: effective_on.prev_year + 10.days,
                        status: 'inactive', created_at: TimeKeeper.date_of_record.prev_day)
    end
