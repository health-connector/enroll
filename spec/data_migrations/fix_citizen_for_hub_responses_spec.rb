...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  ...
  ACCEPTABLE_STATES = %w[us_citizen naturalized_citizen alien_lawfully_present lawful_permanent_resident indian_tribe_member not_lawfully_present_in_us].freeze
