...
describe ChangeEnrollmentDetails do
  ...
  describe "changing enrollment attributes" do
    ...
    it "should change effective on date" do
      ClimateControl.modify hbx_id: "#{hbx_enrollment.hbx_id},#{hbx_enrollment2.hbx_id}", new_effective_on: (hbx_enrollment.effective_on + 1.month).to_s, action: "change_effective_date" do
    ...
    it "should move enrollment to enrolled status from canceled status" do
      ClimateControl.modify hbx_id: "#{hbx_enrollment.hbx_id},#{hbx_enrollment2.hbx_id}", new_effective_on: (hbx_enrollment.effective_on + 1.month).to_s, action: "revert_cancel" do
    ...
    context "revert enrollment termination for individual enrollment" do
      before do
        ClimateControl.modify hbx_id: term_enrollment3.hbx_id.to_s, action: "revert_termination" do
          subject.migrate
    ...
    context "terminate enrollment with given termination date" do
      ...
      shared_examples_for "termination" do |val, result|
        it "should equals #{result}" do
          ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, action: "terminate",terminated_on: "01/01/2016" do
            subject.migrate
            hbx_enrollment.reload
    ...
    context "it should cancel the enrollment when it is eligible for cancelling" do
      ...
      it "should cancel the enrollment when it is eligible for cancelling" do
        ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, action: "cancel" do
    ...
    context "generate_hbx_signature" do
      ...
      it "should have a enrollment_signature" do
        ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, action: "generate_hbx_signature" do
    ...
    context "expire the enrollment" do
      ...
      it "should expire the enrollment" do
        ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, action: "expire_enrollment" do
          subject.migrate
          hbx_enrollment.reload
    ...
    context "change the plan of enrollment" do
      ...
      it "should change the plan of enrollment" do
        ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, action: "change_plan",new_product_id: new_plan.id do
          subject.migrate
          hbx_enrollment.reload
    ...
    context "change the benefit group of enrollment" do
      it "should change the benefit group of enrollment" do
        ClimateControl.modify hbx_id: hbx_enrollment.hbx_id.to_s, new_sponsored_benefit_package_id: new_benefit_group.id, action: "change_benefit_group" do
          subject.migrate
          hbx_enrollment.reload
