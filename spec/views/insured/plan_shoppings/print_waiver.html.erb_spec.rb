...
RSpec.describe "insured/plan_shoppings/print_waiver.html.erb" do
  ...
  before :each do
    ...
    render template: "insured/plan_shoppings/print_waiver"
  end

  it "should show waiver confirmation page" do
    expect(rendered).to have_selector('h3', text: /Waiver confirmation/)
    expect(rendered).to have_selector('p', text: /You have successfully waived the coverage at #{Regexp.escape(format_datetime(hbx_enrollment.updated_at))}\./)
