  ...
  context "ALL link to be added" do
    ...
    context "url_params are present" do
      ...
      it "adds url_params to href url" do
        render "shared/alph_paginate_remote", url: benefit_sponsors.family_index_profiles_broker_agencies_broker_agency_profiles_path, alphs: [],
               all: benefit_sponsors.family_index_profiles_broker_agencies_broker_agency_profiles_path, url_params: url_params
