...
describe "shared/inboxes/_message_list.html.erb" do
  ...
  let(:message_1) { instance_double(Message, {:id => "11111", :created_at=>(Time.new(2016,1,10) + 5.hours)}.merge(shared_message_properties)) }
  let(:message_2) { instance_double(Message, {:id => "22222", :created_at=>(Time.new(2016,11,1) + 5.hours)}.merge(shared_message_properties)) }
