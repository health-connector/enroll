...
RSpec.describe ShopEmployerNotices::RenewalEmployerEligibilityNotice do
  ...
  let!(:active_plan_year) do
    FactoryBot.create :plan_year, employer_profile: employer_profile, aasm_state: "renewing_enrolling", start_on: start_on, end_on: end_on, open_enrollment_start_on: open_enrollment_start_on, open_enrollment_end_on: open_enrollment_end_on
  end
