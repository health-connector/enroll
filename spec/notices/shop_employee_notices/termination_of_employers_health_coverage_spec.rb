...
RSpec.describe ShopEmployeeNotices::TerminationOfEmployersHealthCoverage, :dbclean => :after_each do
  ...
  let!(:benefit_coverage_period_2019) {FactoryGirl.create(:benefit_coverage_period, 
    start_on: benefit_coverage_period_2018.start_on.next_year, 
    end_on: benefit_coverage_period_2018.end_on.next_year, 
    open_enrollment_start_on: benefit_coverage_period_2018.open_enrollment_start_on.next_year, 
    open_enrollment_end_on: benefit_coverage_period_2018.open_enrollment_end_on.next_year.beginning_of_year.end_of_month, 
