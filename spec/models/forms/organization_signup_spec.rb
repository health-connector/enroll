...
describe Forms::OrganizationSignup, "office location kind validtion", :dbclean => :after_each do
  ...
  context "give more than one office location of the branch type" do
    ...
    it "should be valid" do
      subject = Forms::OrganizationSignup.new(legal_name: "asdf", dba: "cas", fein: organization.fein, dob: "2015-1-1", first_name: "aaa", last_name: "bbb", entity_kind: "c_corporation", sic_code: "1111",
                                              office_locations: [office_location_1, office_location_2, office_location_3])
