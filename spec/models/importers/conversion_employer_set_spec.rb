...
describe ::Importers::ConversionEmployerSet do
  ...
  describe "provided a file in xlsx format" do
    ...
    let(:employer_data) do
      {
        :registered_on => registered_on, :action => "Add", :fein => "931100000", :dba => "AGA DBA", :legal_name => "AGA LEGAL",
        :primary_location_address_1 => "799 9TH STREET NW", :primary_location_address_2 => "7TH FLR", :primary_location_city => "Washington",
        :primary_location_state => "DC", :primary_location_zip => "20001", :primary_location_county => "County", :contact_first_name => "THE",
        :contact_last_name => "CONTACT", :contact_email => "THECONTACT@AGA.COM", :contact_phone => "2025552675", :enrolled_employee_count => "14",
        :new_hire_count => "Date of Hire equal to Effective Date", :broker_name => "THE BROKER", :broker_npn => "8262800"
      }
    end
  ...
  describe "provided a file in csv format" do
    ...
    let(:employer_data) do
      {
        :registered_on => registered_on, :action => "Add", :fein => "521782000", :dba => "MCP DBA", :legal_name => "MCP LEGAL",
        :primary_location_address_1 => "3001 P Street N.W.", :primary_location_city => "Washington", :primary_location_state => "DC",
        :primary_location_zip => "20007", :primary_location_county => "County",:mailing_location_address_1 => "3001 P Street N.W.",
        :mailing_location_city => "Washington", :mailing_location_state => "DC", :mailing_location_zip => "20007", :contact_first_name => "The",
        :contact_last_name => "Contact", :contact_email => "thecontact@mcp.com", :contact_phone => "2025554100", :enrolled_employee_count => "3",
        :broker_name => "The Broker", :broker_npn => "629000"
      }
    end
    ...
    let(:base_output_result) do
      "Action,FEIN,Doing Business As,Legal Name,Physical Address 1,Physical Address 2,City,State,Zip,County,Mailing Address 1," \
        ...
        "Plan HIOS Id,Reference Plan - Name,Reference Plan - HIOS Id,Employer Contribution -  Employee,Employer Contribution - Spouse," \
        "Employer Contribution - Domestic Partner,Employer Contribution - Child under 26,Employer Contribution - Child over 26," \
        "Employer Contribution - Disabled child over 26,Import Status,Import Details\nAdd,521782000,MCP DBA,MCP LEGAL,3001 P Street N.W., " \
        ",Washington,DC,20007,County,3001 P Street N.W., ,Washington,DC,20007,The,Contact,thecontact@mcp.com,2025554100,3, ," \
        "3001 P Street N.W., ,Washington,DC,20007,The Broker,629000, , ,07/01/2016,CareFirst BlueCross BlueShield,Single Plan from Carrier," \
        "BC HMO Ref  500 Gold Trad Dental Drug,86052DC0480005-01,BC HMO Ref  500 Gold Trad Dental Drug,86052DC0480005-01,\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
    end
