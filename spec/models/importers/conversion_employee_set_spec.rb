...
describe ::Importers::ConversionEmployeeSet do
  ...
  describe "provided a file in xlsx format" do
    ...
    let(:base_output_result) do
      "Action,Type of Enrollment,Market,Sponsor Name,FEIN,Broker Name,Broker NPN,Hire Date,Benefit Begin Date,Plan Name,QHP Id (ignore)," \
        "CSR Info (ignore),CSR Variant (ignore),HIOS Id,(AUTO) Premium Total,Employer Contribution,(AUTO) Employee Responsible Amt,Subscriber SSN," \
        "Subscriber DOB,Subscriber Gender,Subscriber Premium,Subscriber First Name,Subscriber Middle Name,Subscriber Last Name,Subscriber Email," \
        "Subscriber Phone,Subscriber Address 1,Subscriber Address 2,Subscriber City,Subscriber State,Subscriber Zip,SELF (only one option),Dep1 SSN,Dep1 DOB," \
        "Dep1 Gender,Dep1 Premium,Dep1 First Name,Dep1 Middle Name,Dep1 Last Name,Dep1 Email,Dep1 Phone,Dep1 Address 1,Dep1 Address 2,Dep1 City,Dep1 State," \
        "Dep1 Zip,Dep1 Relationship,Dep2 SSN,Dep2 DOB,Dep2 Gender,Dep2 Premium,Dep2 First Name,Dep2 Middle Name,Dep2 Last Name,Dep2 Email,Dep2 Phone,Dep2 Address 1," \
        "Dep2 Address 2,Dep2 City,Dep2 State,Dep2 Zip,Dep2 Relationship,Dep3 SSN,Dep3 DOB,Dep3 Gender,Dep3 Premium,Dep3 First Name,Dep3 Middle Name,Dep3 Last Name," \
        "Dep3 Email,Dep3 Phone,Dep3 Address 1,Dep3 Address 2,Dep3 City,Dep3 State,Dep3 Zip,Dep3 Relationship,Dep4 SSN,Dep4 DOB,Dep4 Gender,Dep4 Premium,Dep4 First Name,Dep4 Middle Name," \
