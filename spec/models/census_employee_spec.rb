...
RSpec.describe CensusEmployee, type: :model, dbclean: :after_each do
  ...
  describe "Censusdependents validators" do
    ...
    let(:dependent2) {FactoryGirl.build(:census_dependent, employee_relationship: "child_under_26", ssn: 333_333_333, dob: TimeKeeper.date_of_record - 30.years, gender: "male")}
    ...
    context "with duplicate ssn's on dependents" do
      let(:child1) {FactoryGirl.build(:census_dependent, employee_relationship: "child_under_26", ssn: 333_333_333)}
      let(:child2) {FactoryGirl.build(:census_dependent, employee_relationship: "child_under_26", ssn: 333_333_333)}
  ...
  context "multiple employers have active, terminated and rehired employees", dbclean: :around_each do
    ...
    let(:er1_active_employees) do
      FactoryGirl.create_list(:census_employee, er1_active_employee_count,
    ...
    let(:er1_terminated_employees) do
      FactoryGirl.create_list(:census_employee, er1_terminated_employee_count,
                              employer_profile: employer_profile_1, benefit_sponsorship: organization1.active_benefit_sponsorship)
    end
    let(:er1_rehired_employees) do
      FactoryGirl.create_list(:census_employee, er1_rehired_employee_count,
                              employer_profile: employer_profile_1, benefit_sponsorship: organization1.active_benefit_sponsorship)
    end
    let(:er2_active_employees) do
      FactoryGirl.create_list(:census_employee, er2_active_employee_count,
    ...
    let(:er2_terminated_employees) do
      FactoryGirl.create_list(:census_employee, er2_terminated_employee_count,
                              employer_profile: employer_profile_2, benefit_sponsorship: organization2.active_benefit_sponsorship)
    end
  ...
  context "show_plan_end_date?" do
    context "without coverage_terminated_on" do
      ...
      let(:census_employee) do
        FactoryGirl.build :benefit_sponsors_census_employee,
                          employer_profile: employer_profile,
                          benefit_sponsorship: organization.active_benefit_sponsorship,
                          hired_on: hired_on
      end
  ...
  context '.enrollments_for_display', dbclean: :before_each do
    ...
    let(:census_employee) do
      ...
      _family = Family.find_or_build_from_employee_role(employee_role)
      ce
    end
  ...
  context 'enrollments_for_display - when employer has off-cycle benefit application', dbclean: :before_each do
    ...
    before do
      ...
      initial_application.benefit_application_items.create(effective_period: updated_dates, item_kind: 'voluntary', item_kind_reason: 'voluntary')
