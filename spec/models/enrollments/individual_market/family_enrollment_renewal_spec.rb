  ...
  RSpec.describe Enrollments::IndividualMarket::FamilyEnrollmentRenewal, type: :model do
    ...
    describe ".renewal_plan" do
      context "When consumer covered under catastrophic plan" do
        ...
        let!(:current_plan) do
          FactoryBot.create(:plan, market: 'individual', metal_level: 'catastrophic', active_year: TimeKeeper.date_of_record.year, hios_id: "11111111122302-01", csr_variant_id: "01", renewal_plan_id: renewal_plan.id,
                                   cat_age_off_renewal_plan_id: cat_age_off_plan.id)
        end
    ...
    describe ".assisted_renewal_plan", dbclean: :after_each do
      context "When individual currently enrolled under CSR plan" do
        ...
        let!(:current_plan) do
          FactoryBot.create(:plan, market: 'individual', metal_level: 'silver', active_year: TimeKeeper.date_of_record.year, hios_id: "11111111122302-04", hios_base_id: "11111111122302", csr_variant_id: "04", renewal_plan_id: renewal_plan.id)
        end
