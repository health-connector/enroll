...
describe "load_dummy_rates" do
  before :all do
    ...
    @hp1 = FactoryBot.create(:benefit_markets_products_health_products_health_product, issuer_profile_id: issuer_profiles[0].issuer_profile.id,
                                                                                       premium_tables: build_list(:benefit_markets_products_premium_table, 3, effective_period: @application_period))
    @hp2 = FactoryBot.create(:benefit_markets_products_health_products_health_product, issuer_profile_id: issuer_profiles[1].issuer_profile.id,
                                                                                       premium_tables: build_list(:benefit_markets_products_premium_table, 3, effective_period: @application_period))
    @hp3 = FactoryBot.create(:benefit_markets_products_health_products_health_product, issuer_profile_id: issuer_profiles[2].issuer_profile.id,
                                                                                       premium_tables: build_list(:benefit_markets_products_premium_table, 3, effective_period: Range.new(@application_period.min.months_ago(3), @application_period.max.months_ago(3))))
    @hp4 = FactoryBot.create(:benefit_markets_products_health_products_health_product, issuer_profile_id: issuer_profiles[3].issuer_profile.id,
                                                                                       premium_tables: build_list(:benefit_markets_products_premium_table, 3, effective_period: Range.new(@application_period.min.months_ago(3), @application_period.max.months_ago(3))))
