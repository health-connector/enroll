  ...
  skip "Rake task depricated, & rake task & spec moved to new model" do
    ...
    describe 'migrations:terminate_employer_account' do
      ...
      let(:active_plan_year)  do
        FactoryBot.build(:plan_year, start_on: TimeKeeper.date_of_record.next_month.next_month.beginning_of_month - 1.year, end_on: TimeKeeper.date_of_record.next_month.end_of_month, aasm_state: 'active',benefit_groups: [benefit_group])
      end
