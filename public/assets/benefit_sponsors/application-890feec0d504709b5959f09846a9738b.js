...
initDatepicker('eeDOB',new Date('03/01/1922'),new Date('03/01/2006'))
  
initDatepicker('hiredDate',new Date('02/15/2022'),new Date('03/08/2022'))
...
$(function() {
  ...
  initDatepicker('inputDOB',new Date('03/01/1932'),new Date('03/31/2004'));
});
