...
initDatepicker('eeDOB',new Date('10/01/1918'),new Date('10/01/2002'))
  
initDatepicker('hiredDate',new Date('09/17/2018'),new Date('10/08/2018'))
...
$(function() {
  ...
  initDatepicker('inputDOB',new Date('10/01/1928'),new Date('10/31/2000'));
});
