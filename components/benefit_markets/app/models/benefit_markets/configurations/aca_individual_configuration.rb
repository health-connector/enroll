module BenefitMarkets
  module Configurations
    class AcaIndividualConfiguration < BenefitMarkets::Configurations::Configuration
      ...
      field :open_enrl_start_on,   as: :open_enrollment_start_on, type: Date, default: Date.new(2018,11,1)
      field :open_enrl_end_on,     as: :open_enrollment_end_on, type: Date, default: Date.new(2019,01,31)
