    ...
    module Products
      class Find
        ...
        def products_for_kind_and_date(product_package, effective_date)
          ...
          @@products_for_date[calendar_year] ||= {}
          @@products_for_date[calendar_year][product_package.benefit_kind] ||= {}

          # Return cached products if they already exist
          cached_products = @@products_for_date[calendar_year][product_package.benefit_kind][product_package.product_kind]
          ...
          @@products_for_date[calendar_year][product_package.benefit_kind][product_package.product_kind] = cached_products
          cached_products
        end

        def serialized_product_for(product)
          # Return cached serialized product if available
          cached_product = @@serialized_product_hash[product._id]
          ...
          @@serialized_product_hash[product._id] = serialized_product
          serialized_product
        end
