  ...
  class BenefitApplications::AcaShopEnrollmentEligibilityPolicy
    ...
    rule  :non_business_owner_enrollment_count,
            validate: ->(benefit_application){
                            benefit_application.enrolled_non_business_owner_members.count <= benefit_application.members_eligible_to_enroll_count &&
                            benefit_application.enrolled_non_business_owner_members.count >= Settings.aca.shop_market.non_owner_participation_count_minimum.to_f
                          },
            success:  ->(benefit_application){"validated successfully"},
