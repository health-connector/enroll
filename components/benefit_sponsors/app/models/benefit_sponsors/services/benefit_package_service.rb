  ...
  module Services
    class BenefitPackageService
      ...
      def reference_product_details(form, details)
        ...
        sbc_url = "/documents/#{sbc_document.id}/product_sbc_download?content_type=application/pdf&filename=#{product.title.gsub(/[^0-9a-z]/i,'')}.pdf&product_id=#{product.id}&disposition=inline"
