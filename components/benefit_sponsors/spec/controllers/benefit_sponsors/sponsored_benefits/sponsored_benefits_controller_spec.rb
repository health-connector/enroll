...
RSpec.describe BenefitSponsors::SponsoredBenefits::SponsoredBenefitsController, type: :controller, dbclean: :after_each do
  ...
  let(:sponsor_contribution_attributes) {{ :contribution_levels_attributes => contribution_levels_attributes }}
  ...
  describe "POST create", dbclean: :after_each do
    ...
    context "successful create and redirect to employer estimated costs page" do
      it "does a successful redirect" do
        params = {
          benefit_package_id: benefit_package.id, benefit_application_id: benefit_application.id, benefit_sponsorship_id: benefit_sponsorship.id,
          sponsored_benefits: sponsored_benefits_params, :estimated_employee_costs => "true"
        }
        sign_in user
  ...
  describe "POST update" do
    ...
    let(:required_params) do
      {
        id: @sponsored_benefit_form.service.package.id, benefit_package_id: benefit_package.id, benefit_application_id: benefit_application.id,
        benefit_sponsorship_id: benefit_sponsorship.id, sponsored_benefits: sponsored_benefits_params
      }
    end
    ...
    before :each do
      ...
      put :update, params: required_params
    end
