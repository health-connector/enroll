      ...
      context "scopes" do
        context "benefit application" do
          context "applicant" do
            before do
              # applicant_attributes = {"employers" => "benefit_sponsorship_applicant"}.with_indifferent_access
            end

            xit "should return a valid datatable only including applicant benefit applications" do
          ...
          context "enrolling" do
            before do
              # enrolling_attributes = {"employers" => "benefit_application_enrolling"}.with_indifferent_access

            end

            xit "should  a valid datatable only including enrolling benefit applications" do
        ...
        context "employer attestations" do
          ...
          context "denied" do
            ...
            xit "should return a valid datatable only including denid employer attestation benefit sponsorships" do
