...
module BenefitSponsors
  RSpec.describe BenefitSponsorships::BenefitSponsorship, type: :model, dbclean: :after_each do
    ...
    describe "Working with subclassed parent Profiles" do
      context "using sic_code helper method" do
        ...
        context "on cca_employer_profile with attribute defined but not set" do
          before do
            cca_employer_profile.sic_code = nil
            cca_employer_profile.add_benefit_sponsorship
          end
        ...
        context "on cca_employer_profile with attribute defined" do
          before do
            cca_employer_profile.sic_code = sic_code
            cca_employer_profile.add_benefit_sponsorship
          end
    ...
    describe "Scopes", :dbclean => :after_each do
      ...
      context '.may_transmit_renewal_enrollment?' do
        ...
        let!(:april_wrong_sponsorship_renewal_sponsors)  do
          create_list(:benefit_sponsors_benefit_sponsorship, 1, :with_organization_cca_profile,
                      :with_renewal_benefit_application, initial_application_state: initial_application_state,
        ...
        context "when overlapping benefit application present with status as" do
          ...
          let!(:new_application)              do
            create(:benefit_sponsors_benefit_application,
                   ...
                   default_effective_period: (new_effective_date..(new_effective_date + 1.year - 1.day)),
                   aasm_state: :canceled)
          end
    ...
    describe ".application_event_subscriber(aasm)", :dbclean => :after_each do
      ...
      let!(:aasm_state) do
        double("AASM::InstanceBase", current_event: :expire!,
                                     from_state: :active,
                                     name: :default,
                                     to_state: :expired)
      end
    ...
    # }
      ...
      context "when benefit application is terminated" do
        ...
        let!(:aasm_state) do
          double("AASM::InstanceBase", current_event: :terminate_enrollment!,
                                       from_state: :active,
                                       name: :default,
                                       to_state: :terminated)
        end
      ...
      context "when benefit application is canceled" do
        ...
        let!(:aasm_state) do
          double("AASM::InstanceBase", current_event: :activate_enrollment!,
                                       from_state: :active,
                                       name: :default,
                                       to_state: :canceled)
        end
    ...
    describe '.extend_open_enrollment', :dbclean => :after_each do
      ...
      let!(:aasm) do
        double("AASM::InstanceBase", current_event: :extend_open_enrollment!,
                                     from_state: :canceled,
                                     name: :default,
    ...
    describe '.is_potential_off_cycle_employer', dbclean: :after_each do
      ...
      shared_examples_for "for an employer on the exchange" do |aasm_state_initial, aasm_state_renewal, expectation|
        let!(:current_application)           { create(:benefit_sponsors_benefit_application, aasm_state: aasm_state_initial, default_effective_period: effective_period, benefit_sponsorship: active_benefit_sponsorship) }
        let!(:renewal_application) do
          return unless aasm_state_renewal.present?

          create(:benefit_sponsors_benefit_application, aasm_state: aasm_state_renewal, default_effective_period: renewal_effective_period, benefit_sponsorship: active_benefit_sponsorship)
        end
      ...
      context 'employer has multiple canceled applications after terminated application' do
        ...
        let!(:canceled_app1)              { create(:benefit_sponsors_benefit_application, aasm_state: :canceled, default_effective_period: renewal_effective_period, benefit_sponsorship: active_benefit_sponsorship) }
        let!(:canceled_app2)              { create(:benefit_sponsors_benefit_application, aasm_state: :canceled, default_effective_period: renewal_effective_period, benefit_sponsorship: active_benefit_sponsorship) }
        let!(:canceled_app3)              { create(:benefit_sponsors_benefit_application, aasm_state: :canceled, default_effective_period: renewal_effective_period, benefit_sponsorship: active_benefit_sponsorship) }
        let!(:canceled_app4)              { create(:benefit_sponsors_benefit_application, aasm_state: :canceled, default_effective_period: renewal_effective_period, benefit_sponsorship: active_benefit_sponsorship) }
    ...
    describe '.off_cycle_benefit_application' do
      ...
      shared_examples_for "for off-cycle employer" do |aasm_state_initial, aasm_state_renewal, aasm_state_off_cycle, expectation|
        ...
        let!(:offcycle_application) do
          ...
          create(:benefit_sponsors_benefit_application, aasm_state: aasm_state_off_cycle, default_effective_period: offcycle_effective_period, benefit_sponsorship: active_benefit_sponsorship)
        end
        let!(:renewal_application) do
          return unless aasm_state_renewal.present?
