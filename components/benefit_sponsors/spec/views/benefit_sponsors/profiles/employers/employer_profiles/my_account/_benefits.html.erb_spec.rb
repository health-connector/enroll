  ...
  context "Add Plan year display" do
    ...
    context "renewals" do
      ...
      let(:renewal_benefit_sponsor_catalog) do
        build(:benefit_markets_benefit_sponsor_catalog, effective_date: renewal_effective_date, effective_period: renewal_effective_date..renewal_effective_date.next_year.prev_day,
