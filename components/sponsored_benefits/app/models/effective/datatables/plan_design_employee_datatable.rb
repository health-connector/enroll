    ...
    class PlanDesignEmployeeDatatable < ::Effective::MongoidDatatable
      ...
      datatable do
        ...
        bulk_actions_column do
          bulk_action 'Employee will enroll',  expected_selection_plan_design_proposal_plan_design_census_employees_path(@plan_design_proposal.proposal, :expected_selection => "enroll"),
                      data: {confirm: 'These employees will be used to estimate your group size and participation rate', no_turbolink: true}
          bulk_action 'Employee will not enroll with valid waiver', expected_selection_plan_design_proposal_plan_design_census_employees_path(@plan_design_proposal.proposal, :expected_selection => "waive"),
                      data: {confirm: 'Remember, your group size can affect your premium rates', no_turbolink: true}
          bulk_action 'Employee will not enroll with invalid waiver', expected_selection_plan_design_proposal_plan_design_census_employees_path(@plan_design_proposal.proposal, :expected_selection => "will_not_participate"),
