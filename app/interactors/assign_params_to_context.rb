...
class AssignParamsToContext
  ...
  def call
    context.change_plan = context.params[:change_plan].present? ? params[:change_plan] : ''
    ...
    context.coverage_kind = context.params[:coverage_kind].present? ? params[:coverage_kind] : 'health'
    context.enrollment_kind = context.params[:enrollment_kind].present? ? params[:enrollment_kind] : ''
    context.shop_for_plans = context.params[:shop_for_plans].present? ? params[:shop_for_plans] : ''
    context.optional_effective_on = context.params[:effective_on_option_selected].present? ? Date.strptime(params[:effective_on_option_selected], '%m/%d/%Y') : nil
