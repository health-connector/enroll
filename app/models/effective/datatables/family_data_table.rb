  ...
  module Datatables
    class FamilyDataTable < Effective::MongoidDatatable
      ...
      datatable do
        ...
        table_column :active_enrollments, :label => 'Active Enrollments?', :proc => proc { |row| row.active_household.hbx_enrollments.active.enrolled_and_renewing.present? ? "Yes" : "No"}, :filter => false, :sortable => false
