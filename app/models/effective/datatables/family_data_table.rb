      ...
      datatable do
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          dropdown = [
                      ...
                      ['Add SEP', add_sep_form_exchanges_hbx_profiles_path(family: row.id, family_actions_id: "family_actions_#{row.id}"), add_sep_link_type(pundit_allow(HbxProfile, :add_new_sep?))],
