...
# This controller is responsible for the :new, :create, :show and :destroy actions of an employee-embedded inbox
class Insured::InboxesController < InboxesController # rubocop:disable Style/ClassAndModuleChildren
  ...
  def authorize_inbox_access
    ...
    # We're using a FamilyPolicy method here because a modifying a Employee/Consumer Inbox has all of the same permissions as Family
