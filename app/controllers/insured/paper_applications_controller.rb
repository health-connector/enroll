class Insured::PaperApplicationsController < ApplicationController
  ...
  def upload
    authorize @family, :upload_paper_application_coverall?
    ...
    return redirect_to(upload_application_insured_families_path) unless validate_file_upload(params[:file], FileUploadValidator::VERIFICATION_DOC_TYPES)
  ...
  def download
    authorize @family, :download_paper_application_coverall?
