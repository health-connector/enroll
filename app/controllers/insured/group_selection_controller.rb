class Insured::GroupSelectionController < ApplicationController
  ...
  def create
    ...
    flash[:warning] = "User has not created a family. Please contact customer service at #{Settings.contact_center.phone_number}" if @adapter.family.active_household.nil?
    ...
    unless @adapter.is_waiving?(params)
      ...
      family_member_ids = params.require(:family_member_ids).collect do |_index, family_member_id|
