...
module IndividualMarket
  class AgentsController < ApplicationController
    ...
    def check_agent_role
      redirect_to root_path, :flash => { :error => "You must be an Agent:  CSR, CAC, IPA or a Broker" } unless current_user.has_agent_role? || current_user.has_hbx_staff_role? || current_user.has_broker_role?
