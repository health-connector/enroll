  ...
  def migrate
    begin
      ...
      feins.each do |fein|
        ...
        benefit_applications = org.employer_profile.benefit_applications.where(:aasm_state.in => BenefitSponsors::BenefitApplications::BenefitApplication::PUBLISHED_STATES)
        if (benefit_applications.count == 0)
          ...
          benefit_applications.each do |ba|
            ...
            product_packages.each do |product_package|
              ...
              products = ::BenefitMarkets::Products::Product.where(:hios_id.in => hios_ids).select{|a| a.active_year == ba.start_on.year}
