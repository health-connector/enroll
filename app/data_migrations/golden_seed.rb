...
class GoldenSeed < MongoidMigrationTask
  ...
  def migrate
    # source_csv = ENV['csv_filename'].to_s)
    # if source_csv.present?
      # TODO
    # else
      # TODO
    # end
    ...
    #    family_structure_list.each do |family_structure|
    #      employer = generate_and_return_new_employer
  ...
  def generate_and_return_new_employer
