...
# RAILS_ENV=production bundle exec rake migrations:change_employer_contributions fein=264793467 aasm_state=renewing_enrolling coverage_kind=health/dental relationship_name=spouse contribution_factor=75 is_offered=true
