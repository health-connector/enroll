...
# RAILS_ENV=production bundle exec rake migrations:updating_broker_agency_account_or_profile fein=999900675 npn='61612' market_kind='both' legal_name='The Haney Company' address_1="308 Southwest Drive" address_2="", city="Silver Spring" state="MD" zip="20901" area_code="301" number="593-0600" action="create_org_and_broker_agency_profile"
